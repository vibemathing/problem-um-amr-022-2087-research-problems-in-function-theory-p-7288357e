...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-022-2087"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-v1",
      "problem_contract_sha256": "b5acf3787a52fa62aa3d5fe1fdbf3baa1c73b995c698dbe46a0e840aba2e8e9a",
      "problem_id": "problem:um-amr-022-2087-research-problems-in-function-theory-p-7288357e",
      "route_id": "route:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-source-fidelity-01",
      "graph_id": "graph:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a non-linear entire function $g$ with wandering domain $W$ such that $\\bigcup_{n\\geq0}g^n(W)$ is bounded in $\\mathbb{C}$? It has been conjectured by Lyubich that if $g$ and $W$ exist, then $g^n(W)$ cannot converge as $n\\to\\infty$ to a fixed point of $g$. (M. R. Herman; A. Eremenko and M. Yu. Lyubich)"
          },
          "statement_sha256": "69ab52f6b8676550ef89371d7d3f3e1114e01f9f893f14cec65c501212a60c1e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-root",
      "route_id": "route:um-amr-022-2087-research-problems-in-function-theory-p-7288357e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-022-2087-250e5e4d5217",
        "url": "https://www.unsolvedmath.com/problems/AMR-022-2087"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
